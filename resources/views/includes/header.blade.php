            ...
            <nav class="navbar navbar-expand-xl navbar-light bg-transparent">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="{{ asset('assets/front/dist/images/logo/logo.png') }}" alt="Logo" class="img-fluid">
                    </a>
                    ...
                    <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route('clubs.index') }}">
                                    Clubs
                                </a>
                            </li>
                          
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route('evenements.index') }}">
                                    Evènements
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="d-flex align-items-center justify-content-between rightContent">
                            <a href="{{ route('login') }}" class="button button--text">Se connecter</a>
                            <a href="{{ route('register') }}" class="button button--dark">S'inscrire</a>
                        </div>
                    </div>
                                ...
                                <ul class="navbar-mobile__menu-list">
                                    ...
                                    <li class="navbar-mobile__menu-item">
                                        <a href="{{ route('clubs.index') }}">
                                            <span class="navbar-mobile__menu-link"> Clubs </span>
                                            <span class="navbar-mobile__menu-dropicon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                                    <polyline points="9 18 15 12 9 6"></polyline>
                                                </svg>
                                    ...
                                    <li class="navbar-mobile__menu-item">
                                        <a href="{{ route('evenements.index') }}">
                                            <span class="navbar-mobile__menu-link"> Evènements </span>
                                        </a>
                                    </li>
                                    <li class="navbar-mobile__menu-item">
